...
var file_nika_operator_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x22, 0xb6, 0x01, 0x0a, 0x1e, 0x4c, 0x69, 0x73, 0x74,
...
var file_nika_operator_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_nika_operator_proto_depIdxs = []int32{
	...
	6, // 5: NikaOperator.ListKubernetesAPIObject:input_type -> ListKubernetesAPIObjectRequest
	1, // 6: NikaOperator.Exec:output_type -> ExecResponse
	3, // 7: NikaOperator.GetExecRecord:output_type -> GetExecRecordResponse
	5, // 8: NikaOperator.ListExecRecordByAppIDAndEnvNameAndCmd:output_type -> ListExecRecordByAppIDAndEnvNameAndCmdResponse
	7, // 9: NikaOperator.ListKubernetesAPIObject:output_type -> ListListKubernetesAPIObjectResponse
